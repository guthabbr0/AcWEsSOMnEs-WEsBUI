...
ENABLE_OAUTH_PERSISTENT_CONFIG = os.getenv('ENABLE_OAUTH_PERSISTENT_CONFIG', 'True').lower() == 'true'
...
def load_oauth_providers():
    ...
    if (
        globals().get('DISCORD_OAUTH_ENABLED')
        and DISCORD_OAUTH_ENABLED.value
        and DISCORD_CLIENT_ID.value
        and DISCORD_CLIENT_SECRET.value
    ):
    ...
    if (
        globals().get('GITLAB_OAUTH_ENABLED')
        and GITLAB_OAUTH_ENABLED.value
        and GITLAB_CLIENT_ID.value
        and GITLAB_CLIENT_SECRET.value
    ):
    ...
    if (
        globals().get('SLACK_OAUTH_ENABLED')
        and SLACK_OAUTH_ENABLED.value
        and SLACK_CLIENT_ID.value
        and SLACK_CLIENT_SECRET.value
    ):
    ...
    if globals().get('DISCORD_CLIENT_ID') and DISCORD_CLIENT_ID.value:
        configured_providers.append('Discord')
    if globals().get('GITLAB_CLIENT_ID') and GITLAB_CLIENT_ID.value:
        configured_providers.append('GitLab')
    if globals().get('SLACK_CLIENT_ID') and SLACK_CLIENT_ID.value:
...
####################################
# Awesome WebUI config keys (ported from PersistentConfig)
####################################

# Awesome WebUI helper values for config defaults below
oauth_allowed_login_providers = os.getenv('OAUTH_ALLOWED_LOGIN_PROVIDERS', '').strip()
oauth_allowed_signup_providers = os.getenv('OAUTH_ALLOWED_SIGNUP_PROVIDERS', '').strip()
invite_creator_group_ids = os.getenv('INVITE_CREATOR_GROUP_IDS', '[]')
invite_codes = os.getenv('INVITE_CODES', '[]')


CUSTOM_EMOJI_LIBRARY = ConfigVar(
...
DISCORD_ACCESS_TOKEN_URL = ConfigVar(
...
DISCORD_API_BASE_URL = ConfigVar(
...
DISCORD_AUTHORIZE_URL = ConfigVar(
...
DISCORD_CLIENT_SECRET = ConfigVar(
...
DISCORD_OAUTH_ENABLED = ConfigVar(
...
DISCORD_REDIRECT_URI = ConfigVar(
...
DISCORD_USERINFO_ENDPOINT = ConfigVar(
...
ENABLE_INVITE_ONLY_AUTH = ConfigVar(
...
ENABLE_PASSWORD_SIGNUP = ConfigVar(
...
ENABLE_SYSTEM_NOTICE = ConfigVar(
...
FEISHU_ACCESS_TOKEN_URL = ConfigVar(
...
FEISHU_AUTHORIZE_URL = ConfigVar(
...
FEISHU_OAUTH_ENABLED = ConfigVar(
...
FEISHU_USERINFO_ENDPOINT = ConfigVar(
...
GITHUB_ACCESS_TOKEN_URL = ConfigVar(
...
GITHUB_AUTHORIZE_URL = ConfigVar(
...
GITHUB_OAUTH_ENABLED = ConfigVar(
...
GITHUB_USERINFO_ENDPOINT = ConfigVar(
...
GITLAB_ACCESS_TOKEN_URL = ConfigVar(
...
GITLAB_AUTHORIZE_URL = ConfigVar(
...
GITLAB_CLIENT_SECRET = ConfigVar(
...
GITLAB_OAUTH_ENABLED = ConfigVar(
...
GITLAB_USERINFO_ENDPOINT = ConfigVar(
...
GOOGLE_OAUTH_ENABLED = ConfigVar(
...
GOOGLE_SERVER_METADATA_URL = ConfigVar(
...
INVITE_CODE_MAX_USES = ConfigVar(
...
INVITE_CODE_REUSABLE = ConfigVar(
...
INVITE_CODE_TTL_SECONDS = ConfigVar(
...
INVITE_CREATOR_COOLDOWN_SECONDS = ConfigVar(
...
INVITE_CREATOR_GROUP_IDS = ConfigVar(
...
INVITE_CREATOR_SCOPE = ConfigVar(
...
MICROSOFT_OAUTH_ENABLED = ConfigVar(
...
NOTIFICATION_SOUND_LIBRARY = ConfigVar(
...
OAUTH_ALLOWED_LOGIN_PROVIDERS = ConfigVar(
...
OAUTH_ALLOWED_SIGNUP_PROVIDERS = ConfigVar(
...
SLACK_ACCESS_TOKEN_URL = ConfigVar(
...
SLACK_USERINFO_ENDPOINT = ConfigVar(
...
SYSTEM_NOTICE_CONTENT = ConfigVar(
